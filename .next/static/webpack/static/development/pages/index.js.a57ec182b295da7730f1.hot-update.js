  ...
  var handleClickSearch = function handleClickSearch(search) {
    if (search.length > 0) {
      setItems(items.filter(function (item) {
        return item["firstName"].toLowerCase().includes(search.toLowerCase()) || item["lastName"].toLowerCase().includes(search.toLowerCase()) || item["email"].toLowerCase().includes(search.toLowerCase()) || item["phone"].toLowerCase().includes(search.toLowerCase()) || item["id"].toLowerCase().includes(search.toLowerCase());
      }));
    }
...
//# sourceMappingURL=index.js.a57ec182b295da7730f1.hot-update.js.map